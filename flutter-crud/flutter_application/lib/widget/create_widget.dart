          ...
          body: SafeArea(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                FFButtonWidget(
  onPressed: () async {
    // Collect the input values from the text fields
    final firstName = _model.textfieldTextController1?.text ?? '';
    final lastName = _model.textfieldTextController2?.text ?? '';
    final email = _model.textfieldTextController3?.text ?? '';

    // Navigate to the 'read' page and pass the collected data
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ReadWidget(
          firstName: firstName,
          lastName: lastName,
          email: email,
        ),
