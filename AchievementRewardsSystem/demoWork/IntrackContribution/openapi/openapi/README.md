...
OpenAPI definition
- API version: v0
  - Build date: 2024-10-23T14:46:39.591989600+05:30[Asia/Calcutta]
...
------------ | ------------- | ------------- | -------------
*BalancedScoreCardControllerApi* | [**showDetails**](docs/BalancedScoreCardControllerApi.md#showDetails) | **GET** /get | 


## Documentation for Models

 - [BalancedScoreCardEntity](docs/BalancedScoreCardEntity.md)
