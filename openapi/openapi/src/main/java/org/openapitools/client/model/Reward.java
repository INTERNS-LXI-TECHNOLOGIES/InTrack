 ...
 * Reward
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-18T20:28:37.881887400+05:30[Asia/Calcutta]", comments = "Generator version: 7.9.0")
public class Reward {
  ...
  public Reward points(String points) {
    this.points = points;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, reward.id) &&
        ...
        Objects.equals(this.points, reward.points);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reward.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Reward` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
