...
import 'package:demo/model/update_model.dart';
...
export 'package:demo/model/update_model.dart';
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () {
                              final name1 = ModalRoute.of(context)!
                                  .settings
                                  .arguments as Intern;
                              final newName =
                                  _model.textFieldTextController?.text.trim();
                              final newAge =
                                  _model.textController2?.text.trim();
                              final newEmail =
                                  _model.textController3?.text.trim();
                              _internController.updateInterns(
                                  name1.name, newName!, newAge!, newEmail!);
