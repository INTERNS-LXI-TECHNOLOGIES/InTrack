...
class UserControllerApi {
  ...
  Future<Response<void>> deletUser({ 
    required int id,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> geUserByName({ 
    ...
    final _path = r'/api/users/name/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> getAllUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/showAll';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<User>> postUser({ 
    ...
    final _path = r'/api/users/create';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
